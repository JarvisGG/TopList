package com.topList.android.bottomsheet.ui
...
import com.basefex.exchange.widget.sheet.action.BottomSheetFunction
...
abstract class BottomSheetFragment: BaseFragment(), IBottomSheetOperator {
    ...
    var topIndicatorLineHeight = 12.dp2px.toInt()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val actionSheet = rootView.findViewById<ActionSheetLayout>(R.id.actionSheet)
...
//                val params = shadow.layoutParams as ConstraintLayout.LayoutParams
//                params.bottomMargin = ((actionSheet.measuredHeight - deltaY - 20.dp2px).toInt())
