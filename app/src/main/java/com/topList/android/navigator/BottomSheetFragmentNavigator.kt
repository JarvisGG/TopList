...
class BottomSheetFragmentNavigator(var context: Context, var  manager: FragmentManager) : Navigator<BottomSheetFragmentNavigator.Destination>() {
    ...
    override fun navigate(
        ...
        ft.add(R.id.overlayPlace, bottomSheetFragment, SHEET_TAG + destination.id)
        ft.commit()
    ...
    class Destination : NavDestination {
        ...
        constructor(fragmentNavigator: Navigator<out BottomSheetFragmentNavigator.Destination>) : super(fragmentNavigator)
