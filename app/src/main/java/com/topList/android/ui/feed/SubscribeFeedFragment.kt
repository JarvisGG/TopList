...
import kotlinx.android.synthetic.main.fragment_subscribe_feed.*
import me.saket.inboxrecyclerview.dimming.TintPainter
import me.saket.inboxrecyclerview.page.InterceptResult
import me.saket.inboxrecyclerview.page.OnPullToCollapseInterceptor
import me.saket.inboxrecyclerview.page.SimplePageStateChangeCallbacks

class SubscribeFeedFragment : BasePagingFragment(), IContainerPager {

    companion object {
        fun create() = SubscribeFeedFragment()
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_subscribe_feed, container, false)
    }
